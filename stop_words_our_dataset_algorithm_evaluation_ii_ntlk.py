# -*- coding: utf-8 -*-
"""Stop Words - Our Dataset - Algorithm Evaluation II -  NTLK.ipynb
...
setenceswithstemming = applystemmer(basetreinamento)
...
dataset_complete = nltk.classify.apply_features(extratorword, setenceswithstemming)
#print(dataset_complete)

classifier = nltk.NaiveBayesClassifier.train(dataset_complete)
